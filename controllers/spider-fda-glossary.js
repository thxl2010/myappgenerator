 ...
 * @Last Modified time: 2020-04-22 22:04:46
 */
var fs = require('fs');
...
// ema Glossary
const GLOSSARY_URL = 'https://www.fda.gov/patients/clinical-trials-what-patients-need-know/glossary-terms#A-1';
let LETTER_LIST = [];
const PAGE_LIST = [];
...
function init(req, res, next) {
  superagent.get(GLOSSARY_URL).end(function(err, pres) {
    ...
    $('[role="main"] h3').each(function(i, item) {
      var letter = $(item)
        .text()
        .charAt(0);
      if (letter !== '#') {
